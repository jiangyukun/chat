...
class SendImage extends Component {
    ...
    sendImageMessage() {
        chatActions.sendImageMessage(this.props.to, this.refs.selectImage.getImageFile())
        this.toggle()
    }
        ...
        return (
            <Modal show={this.state.show}>
                ...
                <Modal.Footer>
                    ...
                    <Button className="btn btn-primary" onClick={()=>{this.sendImageMessage()}}
                            disabled={!this.state.hasImage}>发送</Button>
                </Modal.Footer>
            </Modal>
        )
    }
